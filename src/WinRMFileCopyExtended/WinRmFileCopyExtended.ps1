...
try
{
    ...
    if($verbose)
    {
        Write-Output "machineNames=$machineNames"
        Write-Output "adminUserName=$adminUserName"
        Write-Output "sourcePath=$sourcePath"
        Write-Output "targetPath=$targetPath"
        Write-Output "cleanTargetBeforeCopy=$cleanTargetBeforeCopy"
        Write-Output "copyFilesInParallel=$copyFilesInParallel"
        Write-Output "useSsl=$useSsl"
    }
